...
namespace HealthCareSystem.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Registration(User user)
        {
            ...
            // Save normal users only (NOT Admin)
    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Login(string Email, string Password, string UserType)
        {
            ...
            if (UserType.ToLower() == "admin")
            {
                ...
                HttpContext.Session.SetInt32("UserId", admin.SystemId);
                HttpContext.Session.SetString("UserName", admin.FirstName ?? "Admin");
                HttpContext.Session.SetString("UserType", "Admin");
            ...
            HttpContext.Session.SetString("UserName", user.FirstName ?? "Patient");
            HttpContext.Session.SetString("UserEmail", user.Email ?? "");
            HttpContext.Session.SetString("UserType", user.UserType ?? "patient");
