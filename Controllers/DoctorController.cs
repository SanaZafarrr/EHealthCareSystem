    ...
    public class DoctorController : Controller
    {
        ...
        public IActionResult AddPrescription()
        {
            ...
            var confirmedAppointments = _context.Appointments
                .Where(a => a.DoctorName == doctorName && a.Status == "Confirmed")
                .ToList();
        ...
        public IActionResult CreatePrescription(Prescription model)
        {
            ...
            model.DoctorName = HttpContext.Session.GetString("DoctorName");
            model.DoctorId = HttpContext.Session.GetInt32("DoctorId") ?? 0;
